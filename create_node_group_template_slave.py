...
nodegroup_name.send_keys("slave-ngt")
...
slave_node_process_list = ["datanode", "nodemanager"]
...
for i in slave_node_process_list:
    if i in hdfs:
	process = "HDFS:" + i
    elif i in yarn:
	process = "YARN:" + i
...
#process_datanode = driver.find_element_by_id("id_processes_1")
#process_datanode.click()

#process_nodemanager = driver.find_element_by_id("id_processes_5")
#process_nodemanager.click()
